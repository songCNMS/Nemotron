...
def test_nano3_eval_default_remote_job_dir_uses_nemo_run_dir() -> None:
    data = _eval_default_data()

    assert (
        data["run"]["env"]["remote_job_dir"]
...
def test_nano3_eval_default_remote_job_dir_resolves_under_run_dir(
