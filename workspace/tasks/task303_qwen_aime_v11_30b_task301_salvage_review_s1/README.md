...
- This decision does not approve #362 for merge, does not mark task301 as a
  clean training pass, and does not authorize canary execution, AIME/task243
  eval, export, endpoint, promotion, follow-on 30B work, task255 reuse,
  AIME2025 train data, shared deletion, main push, or merge.
