...
#351/task289 is open and clean, but it predates the final task293 AIME evidence
and remains stale/HOLD. task293 read-only artifacts now show a corrected AIME2025
metric pass for task285 Qwen3-4B iter2:
