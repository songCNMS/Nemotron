...
- Synced clean `main` to `d92abd55a32b2135273e7167baba4cd5006683be` before implementation.
- Started branch `intern_nem_dev_2/task034_judge_pool_s1`.
- Implemented the sandbox judge-pool scaffold under `m2_judge_pool`.
