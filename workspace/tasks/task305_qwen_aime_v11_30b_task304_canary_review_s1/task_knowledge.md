...
16. worker_4 verified the final drift independently and approved task304 as
    `APPROVE_TASK304_NON_AIME_CANARY_PASS_WITH_RESIDUALS` for bounded
    synthetic non-AIME checkpoint-load/completion-retention canary evidence
    only.
17. The approval does not clear #367 direct approval, corrected AIME2025/
    task243, export, endpoint, promotion, additional training, task255 reuse,
    AIME2025 train data use, shared deletion, main push, or merge.
